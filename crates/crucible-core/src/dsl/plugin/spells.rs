//! Spell plugins.
//!
//! Sibling task branches independently create this same file for their own
//! spells (SRD 5.2 content, not homebrew) - expected, and reconciled when
//! those branches merge.

use crate::rules::creature::{DamageKind, DamageRoll, Effect, Move, Strike, Uses};
...
mod tests {
    ...
    use crate::rules::creature::{Ability, Creature, Rider, SpellCastingProfile};
